    ...
    for iiter in range(args.global_iteration1): 
        ...
        for iter in range(args.global_iteration2): 
            ...
            for k in range(args.num_clients):     
                ...
                _, task_model[k],_,_,stop[k] = solver[k].train(querry_dataloader[k],val_dataloader[k],task_model[k],vae[k],discriminator[k],unlabeled_train_dataloader[k],lr,0,iter)
        ...
        for iter in range(1): 
            ...
            for k in range(args.num_clients):  
                ...
                Soloaccuracy, task_model[k],vae[k],discriminator[k] = solver[k].train(querry_dataloader[k],val_dataloader[k],task_model[k],vae[k],discriminator[k],unlabeled_train_dataloader[k],lr,0,iter)
        ...
        for iter in range(1): 
            ...
            for k in range(args.num_clients):  
                ...
                _, task_model[k],vae[k],discriminator[k] = solver[k].train(querry_dataloader[k],val_dataloader[k],task_model[k],vae[k],discriminator[k],unlabeled_train_dataloader[k],lr,1,iter)
