...
def get_args():
    ...
    parser.add_argument('--initial_budget', type=int, default=10000, help='initial budget')
    parser.add_argument('--budget', type=int, default=2500, help='budget')
    ...
    parser.add_argument('--lr_solo', type=float, default=0.1, help='learning rate')
    parser.add_argument('--lr_decay', type=float, default=0.995, help='learning rate')

    parser.add_argument('--global_iteration1', type=int, default=6, help='global iteration')
    parser.add_argument('--global_iteration2', type=int, default=100, help='global iteration')
